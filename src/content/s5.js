...
export default {
  ...
  quiz: [
    ...
    { level: 1, q: { en: 'The loss is 0. What does that mean?', ro: 'Eroarea este 0. Ce înseamnă asta?' }, a: [{ en: 'The guesses are perfect', ro: 'Ghicirile sunt perfecte' }, { en: 'The AI is broken', ro: 'IA e stricată' }, { en: 'The AI lost a game', ro: 'IA a pierdut un joc' }, { en: 'Training has not started', ro: 'Antrenarea nici n-a început' }], c: 0, why: { en: 'Zero loss means no mistakes at all. Big loss = very wrong, small loss = almost right.', ro: 'Eroare zero înseamnă nicio greșeală. Eroare mare = foarte greșit, eroare mică = aproape corect.' } },
    { level: 1, tf: true, q: { en: 'True or false: in the "fix" step, the AI changes its model a tiny bit, so next time it is a little less wrong.', ro: 'Adevărat sau fals: la pasul „corectează”, IA își schimbă puțin modelul, ca data viitoare să greșească un pic mai puțin.' }, c: true, why: { en: 'True. Many tiny fixes, repeated again and again, add up to a well-trained model.', ro: 'Adevărat. Multe corecturi mici, repetate iar și iar, duc la un model bine antrenat.' } },
