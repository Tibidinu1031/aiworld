...
export default {
  ...
  quiz: [
    ...
    { level: 1, q: { en: 'An AI can\'t look at an apple the way you do. What does it look at instead?', ro: 'O IA nu se poate uita la un măr cum te uiți tu. La ce se uită în schimb?' }, a: [{ en: 'Its features, written as numbers', ro: 'La trăsăturile lui, scrise ca numere' }, { en: 'Its name tag', ro: 'La eticheta cu numele lui' }, { en: 'Its smell', ro: 'La mirosul lui' }, { en: 'Nothing at all', ro: 'La nimic' }], c: 0, why: { en: 'An AI turns things into numbers: features like weight, length and color.', ro: 'O IA transformă lucrurile în numere: trăsături ca greutatea, lungimea și culoarea.' } },
    { level: 1, tf: true, q: { en: 'True or false: patterns are always perfect, with no exceptions.', ro: 'Adevărat sau fals: tiparele sunt mereu perfecte, fără nicio excepție.' }, c: false, why: { en: 'False. Most bananas are long, but there can be a tiny banana. A pattern holds most of the time, not always.', ro: 'Fals. Majoritatea bananelor sunt lungi, dar poate exista și o banană mică. Un tipar se potrivește de cele mai multe ori, nu mereu.' } },
    ...
    { level: 2, q: { en: 'If we use 3 features, our dots live in...', ro: 'Dacă folosim 3 trăsături, punctele noastre trăiesc...' }, a: [{ en: '3D space', ro: 'Într-un spațiu 3D' }, { en: 'A single line', ro: 'Pe o singură linie' }, { en: 'A single point', ro: 'Într-un singur punct' }, { en: 'The ocean', ro: 'În ocean' }], c: 0, why: { en: 'Each feature is one direction, so 3 features make a 3D space.', ro: 'Fiecare trăsătură e o direcție, deci 3 trăsături formează un spațiu 3D.' } },
