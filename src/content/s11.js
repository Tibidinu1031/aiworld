...
export default {
  ...
  quiz: [
    ...
    { level: 1, q: { en: 'In reinforcement learning, what is the environment?', ro: 'În învățarea prin recompensă, ce este mediul?' }, a: [{ en: 'The world the agent lives and acts in', ro: 'Lumea în care trăiește și acționează agentul' }, { en: 'A type of reward', ro: 'Un fel de recompensă' }, { en: 'The agent\'s name', ro: 'Numele agentului' }, { en: 'A kind of tree', ro: 'Un fel de copac' }], c: 0, why: { en: 'The agent acts in the environment, and the environment answers with rewards.', ro: 'Agentul acționează în mediu, iar mediul îi răspunde cu recompense.' } },
    { level: 1, tf: true, q: { en: 'True or false: an RL agent tries to collect as much reward as possible over time.', ro: 'Adevărat sau fals: un agent RL încearcă să adune cât mai multă recompensă în timp.' }, c: true, why: { en: 'True. Rewards tell it what is good, so it learns to get more of them.', ro: 'Adevărat. Recompensele îi arată ce e bine, așa că învață să obțină cât mai multe.' } },
